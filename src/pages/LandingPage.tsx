...
const SERVICES = [
  ...
  },
  {
    ...
    hint: 'Browse calendar — highlights deadlines from your abstract analysis',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description: 'Publication intelligence, abstract-based journal fit, and APC details.',
    tone: 'emerald' as const,
    index: '05',
    route: '/journal-insights',
    hint: 'Paste abstract → journal fit → conference deadlines',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
